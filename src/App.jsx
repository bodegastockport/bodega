...
const Spinner = () => (
  <div className="fixed inset-0 flex items-center justify-center" style={{ backgroundColor: "#f3f2ee" }}>
    <div style={{ width: "24px", height: "24px", border: "2px solid #d8d6d0", borderTopColor: "#193c47", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      {/* Public routes — all inside Layout */}
