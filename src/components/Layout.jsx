          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-8 mb-8">
            ...
            <div className="flex flex-col justify-between" style={{ height: "100%" }}>
              ...
              <div className="flex items-center gap-3 mt-6">
                ...
                <a href="https://share.google/FSAX760ymCwOEEG4c" target="_blank" rel="noopener noreferrer" style={{ color: "#1E4D5A", display: "flex" }} onMouseEnter={e => e.currentTarget.style.opacity = "0.7"} onMouseLeave={e => e.currentTarget.style.opacity = "1"}>
