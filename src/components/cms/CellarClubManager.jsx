  ...
  return (
    <div className="space-y-6" style={{ fontFamily: "'Courier New', Courier, monospace" }}>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={openNew}
          style={{ padding: "8px 16px", backgroundColor: "#1E4D5A", color: "#f3f2ee", border: "none", borderRadius: "0px", fontFamily: "'Courier New', Courier, monospace", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.06em", cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}
        ...
        <div style={{ backgroundColor: "#eceae4", border: "1px solid #d8d6d0", padding: "24px" }}>
          ...
          <div className="flex gap-2 mt-4">
            <button
              ...
              style={{ padding: "8px 20px", backgroundColor: saving || !form.name || !form.email ? "#d8d6d0" : "#1E4D5A", color: saving || !form.name || !form.email ? "#777777" : "#f3f2ee", border: "none", borderRadius: "0px", fontFamily: "'Courier New', Courier, monospace", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.06em", cursor: saving || !form.name || !form.email ? "not-allowed" : "pointer", display: "flex", alignItems: "center", gap: "6px" }}
            >
              {saving && <Loader2 className="h-3.5 w-3.5 animate-spin" />} Save member
            </button>
            <button onClick={close} style={{ padding: "8px 16px", backgroundColor: "transparent", color: "#1E4D5A", border: "1px solid #1E4D5A", borderRadius: "0px", fontFamily: "'Courier New', Courier, monospace", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.06em", cursor: "pointer" }}>Cancel</button>
          </div>
        </div>
      )}
          ...
          {filtered.map((m) => (
            <div key={m.id} style={{ backgroundColor: "#eceae4", border: "1px solid #d8d6d0", padding: "16px" }} className="flex items-center gap-4">
              ...
              <div className="flex gap-1 shrink-0">
                <Link to={`/cellar/${m.id}`}>
                  <button style={{ padding: "4px 10px", backgroundColor: "transparent", color: "#1E4D5A", border: "1px solid #1E4D5A", borderRadius: "0px", fontFamily: "'Courier New', Courier, monospace", fontSize: "11px", cursor: "pointer", display: "flex", alignItems: "center", gap: "4px" }}>
