...
const schema = {
  ...
  "@type": "AboutPage",
  "name": "About Bodega — Independent Wine Bar, Stockport",
  "description": "Bodega is a neighbourhood wine bar at Weir Mill, Stockport, built for drinking, not overthinking.",
  "url": "https://bodegawine.co.uk/about",
  "mainEntity": {
    "@type": "LocalBusiness",
...
export default function About() {
  return (
    <>
      <SEO
        title="About Bodega — Independent Wine Bar, Stockport"
        description="We just really like good wine. Bodega is an independent wine bar built for drinking, not overthinking. Find us at Weir Mill, Stockport."
        canonical="/about"
        schema={schema}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2" style={{ minHeight: "calc(100vh - 56px)" }}>
          ...
          <div style={{ position: "relative", minHeight: "50vh" }}>
            <img
              ...
              alt="Inside Bodega wine bar, Weir Mill, Stockport"
              width="1600"
              height="2000"
              loading="eager"
              fetchPriority="high"
